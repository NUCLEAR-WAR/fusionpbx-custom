...
#install packages
apt-get install -y git lsb-release iptables ca-certificates software-properties-common apt-transport-https php8.1 php8.1-fpm libapache2-mod-fcgid php8.1-fpm php8.1-cli
